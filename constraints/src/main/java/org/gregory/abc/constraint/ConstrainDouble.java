...
public class ConstrainDouble {
   ...
   * The simple rule is that if {@code val} is more than {@code max}, this returns {@code max}, or
   * {@code val} otherwise.
   ...
   * The simple rule is that if {@code val} is less than {@code min}, this returns {@code min}, or
   * {@code val} otherwise.
   * @param val A {@link Double} value, representing the value to be constrained.
